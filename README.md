...
- **Model configuration file**: `ultralytics/yaml/v8-n-DRF-MFF.yaml`  
...
## 3.1 Dynamic Receptive Field (DRF)

**Code**: `ultralytics/nn/modules/DRF.py`

**Description**: Dynamic Receptive Field (DRF) module, which enables the network to dynamically adjust its receptive field according to defect scales, thereby enabling effective extraction of multi-scale feature representations. 
